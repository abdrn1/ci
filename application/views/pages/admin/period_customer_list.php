...
<script>
    $(document).ready(function () {
        ...
        print_url = function (period_region, period_street) {
                ...
                url+=`main/period_consum_get_all_print3?period_region=${period_region}&period_street=${period_street}`;
...
//
            ...
            var header = '<table width="100%" border="1" cellspacing="0" cellpadding="5">'
                    ...
                    + '<th width="8%" scope="col">ملاحظة 5</th>'
                    + '<th width="8%" scope="col">ملاحظة 4</th>'
                    + '<th width="8%" scope="col">ملاحظة 3</th>'
                    + '<th width="8%" scope="col">ملاحظة 2</th>'
                    + '<th width="8%" scope="col">ملاحظة 1</th>'
